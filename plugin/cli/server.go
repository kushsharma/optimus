...
func (s *GRPCServer) GetQuestions(ctx context.Context, req *pbp.GetQuestions_Request) (*pbp.GetQuestions_Response, error) {
	...
	return &pbp.GetQuestions_Response{Questions: questions}, nil
}

func (s *GRPCServer) ValidateQuestion(ctx context.Context, req *pbp.ValidateQuestion_Request) (*pbp.ValidateQuestion_Response, error) {
	...
	return &pbp.ValidateQuestion_Response{
		Success: resp.Success,
		Error:   resp.Error,
	}, nil
}

func (s *GRPCServer) DefaultConfig(ctx context.Context, req *pbp.DefaultConfig_Request) (*pbp.DefaultConfig_Response, error) {
	...
	return &pbp.DefaultConfig_Response{
		Config: AdaptConfigsToProto(resp.Config),
	}, nil
}

func (s *GRPCServer) DefaultAssets(ctx context.Context, req *pbp.DefaultAssets_Request) (*pbp.DefaultAssets_Response, error) {
	answers := models.PluginAnswers{}
	for _, ans := range req.Answers {
		answers = append(answers, models.PluginAnswer{
			Question: AdaptQuestionFromProto(ans.Question),
	...
	return &pbp.DefaultAssets_Response{
		Assets: AdaptAssetsToProto(resp.Assets),
	}, nil
}

func (s *GRPCServer) CompileAssets(ctx context.Context, req *pbp.CompileAssets_Request) (*pbp.CompileAssets_Response, error) {
	...
	return &pbp.CompileAssets_Response{
		Assets: AdaptAssetsToProto(resp.Assets),
	}, nil
}
